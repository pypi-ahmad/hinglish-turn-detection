...
This run freezes the first two Whisper encoder layers. Evaluation F1 is 88.34%, accuracy is 88.61%, and the false-complete rate is 9.87%. Partial tuning keeps nearly all the F1 of full tuning with far fewer trainable parameters.
